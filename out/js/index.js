...
openSideButton === null || openSideButton === void 0 ? void 0 : openSideButton.addEventListener('click', () => {
    if (sidebar === null || sidebar === void 0 ? void 0 : sidebar.classList.contains('display')) {
        mainWrap === null || mainWrap === void 0 ? void 0 : mainWrap.classList.remove('display-none');
        sidebar === null || sidebar === void 0 ? void 0 : sidebar.classList.remove('display');
    }
    else {
        mainWrap === null || mainWrap === void 0 ? void 0 : mainWrap.classList.add('display-none');
